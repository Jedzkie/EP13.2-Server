...
#define MAX_PARTY 12
#define BASE_GUILD_SIZE 4                // Base guild members (without GD_EXTENSION)
#define MAX_GUILD (BASE_GUILD_SIZE + 10 * 2) // Increased max guild members +2 per 1 extension levels [Lupus]
